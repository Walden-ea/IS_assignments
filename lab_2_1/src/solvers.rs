...
pub fn simple_solve(given:i32,goal:i32) -> Option<Node<i32>>{
...
pub fn backwards_solve(given:i32,goal:i32) -> Option<Node<i32>>{
...
pub fn uber_solve(given:i32,goal:i32) -> Option<Node<i32>>{
    if given == goal {
